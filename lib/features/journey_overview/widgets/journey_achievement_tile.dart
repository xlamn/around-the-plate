...
class JourneyAchievementTile extends StatelessWidget {
  final Achievement achievement;

  const JourneyAchievementTile({super.key, required this.achievement});
          ...
          if (!achievement.isUnlocked)
            Visibility(
              ...
              child: Column(
                ...
                children: [
                  Padding(
                    padding: const .symmetric(horizontal: AppSizes.spacing12),
                    child: ClipRRect(
